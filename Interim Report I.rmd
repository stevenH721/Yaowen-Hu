...
model1<-glm(newdata$Loan_Approval~newdata$V72+newdata$V71+newdata$V19+newdata$V9,family = binomial(link = "logit"),data = newdata)
a = newdata$Loan_Approval
model1<-glm(a~newdata$V72+newdata$V71+newdata$V19+newdata$V9,family = binomial(link = "logit"),data = newdata)
